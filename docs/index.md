---
description: Getting started with Research Data Management.
---
...
-   :material-book-open-variant:{ .lg .middle } __New to Research Data Management?__
    ...
    **Best for:** first-time visitors with no prior RDM experience.
    ...
    [:octicons-arrow-right-24: Start with Module 1](modules/01-foundations/index.md)

-   :material-magnify:{ .lg .middle } __Looking for something specific?__
    ...
    **Best for:** readers who need a refresher on one topic, such as Git or metadata standards.
    ...
    [:octicons-arrow-right-24: Browse all modules](#modules)
...
-   __1. Foundations of RDM__

    ---

    What research data management is, why it matters, and the FAIR principles.

    [:octicons-arrow-right-24: Read Module 1](modules/01-foundations/index.md)

-   __2. Data Organization & Documentation__

    ---

    Folder structures, naming conventions, metadata standards, and electronic lab notebooks.

    [:octicons-arrow-right-24: Read Module 2](modules/02-data-organization/index.md)

-   __3. Version Control with Git__

    ---

    Why version control matters, core Git workflows, and .gitignore for research data.

    [:octicons-arrow-right-24: Read Module 3](modules/03-version-control/index.md)

-   __4. Collaboration with GitHub & GitLab__

    ---

    Issues, pull requests, GitHub Pages, Zenodo DOIs, CI/CD, and licensing.

    [:octicons-arrow-right-24: Read Module 4](modules/04-collaboration/index.md)

-   __5. Data Standards & Interoperability__

    ---

    Open versus proprietary formats, controlled vocabularies, and Voc4Cat.

    [:octicons-arrow-right-24: Read Module 5](modules/05-data-standards/index.md)

-   __6. Ontologies & Semantic Technologies__

    ---

    RDF, OWL, SKOS, linked data, persistent identifiers, and Reac4Cat.

    [:octicons-arrow-right-24: Read Module 6](modules/06-ontologies/index.md)

-   __7. Data Archiving & Publication__

    ---

    Backup strategy, choosing a repository, Repo4Cat, and data citation.

    [:octicons-arrow-right-24: Read Module 7](modules/07-archiving/index.md)

-   __8. Further Topics & Integration__

    ---

    Reproducible workflows, containerization, case studies, and further reading.

    [:octicons-arrow-right-24: Read Module 8](modules/08-further-topics/index.md)
